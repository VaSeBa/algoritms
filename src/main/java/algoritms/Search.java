...
public class Search {
    public static void main(String[] args) {
        ...
        // Линейный поиск
//        System.out.println(arrayToString(array));
//        System.out.println(searchLinear(array, 100));

        // Бинарный поиск - в начале нужно отсортировать массив
        bubbleSort(array);
        System.out.println(arrayToString(array));
        searchBinary(array, 36);
        System.out.println(searchBinaryRecursive(array, 0, 12, 36));
    }
